 ...
 * @author – Class period
 */ 
public class Receipt2Formatted
{
   public static void main(String [] args)
   {

      //Modify the code to include a variable for the high school’s name
      String schoolName = "Trevor Packer HS Snack Bar";

      //Modify the code to include variables for the prices of each item: prices for drink, candy, hot dog, hamburger
      // Be sure to use the most appropriate data types to store the values: prices with decimals -> double
     ...
     //For example, instead of printing "Drink ...... $1.50", 
      ...
      System.out.println("*     Hot Dog ........." + String.format("%.2f", hotDogPrice) + "          *");
      System.out.println("*     Hamburger ......." + String.format("%.2f", hamburgerPrice) + "          *");
      System.out.println("*                                    *");
      System.out.println("**************************************");
   }
}